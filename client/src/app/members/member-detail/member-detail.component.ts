...
export class MemberDetailComponent implements OnInit, OnDestroy {
  @ViewChild('memberTabs', {static: true}) memberTabs: TabsetComponent; // We use ViewChild to get the memberTab
  member: Member;
  ...
  constructor(public presence: PresenceService, private route: ActivatedRoute, private messageService: MessageService, private accountService: AccountService, private router: Router) { 
    ...
    this.router.routeReuseStrategy.shouldReuseRoute = () => false; // Revisar video 235. Notifying users when they receive a message, time: 10:40
  }
